...
public class test3{
	...
	static void fun(Connection c,BufferedReader br,HashSet days, HashSet months,HashSet dic)
	{
		...
		while ((sCurrentLine = br.readLine()) != null && flag==0) {
			...
			br.mark(1000);
				...
				fun2(c,br2,days, months,dic,tempstr2);
	...
	static void fun2(Connection c,BufferedReader br,HashSet days, HashSet months,HashSet dic,String timestamp)
	{
		String sCurrentLine=" ";
		String qw1,qw2,qw3,qw4,qw5,qw6,qw7,qw8,qw9,temp;
		StringTokenizer toknm = new StringTokenizer(timestamp, ": ");
